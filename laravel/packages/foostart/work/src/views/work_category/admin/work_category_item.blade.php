...
<div class="row margin-bottom-12">
    <div class="col-md-12">
        <a href="{!! URL::route('admin_work_category.edit') !!}" class="btn btn-info pull-right">
            <i class="fa fa-plus"></i>{{trans('work::work_admin.work_category_add_button')}}
        </a>
    </div>
</div>
...
<table class="table table-hover">
    <thead>
        <tr>
            <td style='width:5%'>
                {{ trans('work::work_admin.order') }}
            </td>

            <th style='width:10%'>
                {{ trans('work::work_admin.work_categoty_id') }}
            </th>

            <th style='width:50%'>
                {{ trans('work::work_admin.work_categoty_name') }}
            </th>

            <th style='width:20%'>
                {{ trans('work::work_admin.operations') }}
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <!--OPERATOR-->
            <td>
                <a href="{!! URL::route('admin_work_category.edit', ['id' => $work_category->work_category_id]) !!}">
                    <i class="fa fa-edit fa-2x"></i>
                </a>
                <a href="{!! URL::route('admin_work_category.delete',['id' =>  $work_category->work_category_id, '_token' => csrf_token()]) !!}"
