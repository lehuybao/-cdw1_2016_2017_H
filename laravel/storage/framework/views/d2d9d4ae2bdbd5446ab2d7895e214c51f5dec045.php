...
<div class="row centered-form">
    <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        ...
        <?php echo link_to_route('user.recovery-password','Forgot password?'); ?>

        or <a href="<?php echo URL::route('user.signup'); ?>"><i class="fa fa-sign-in"></i> Signup here</a>
            </div>
        </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('laravel-authentication-acl::client.layouts.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>